...
def detect_variable_type(series: pd.Series) -> str:
    ...
    Returns:
        ...
        'count': integer type count variable
    ...
    # integer and few categories -> count
...
def select_estimator(treatment_type: str, outcome_type: str) -> str:
    """
    Select proper estimator
    
    Args:
        treatment_type: tyoe of treatment
        outcome_type: type of outcome
    
    Returns:
        estimator (ex: 'backdoor.linear_regression')
    """
    # Binary outcome
...
def create_causal_graph_from_data(
    ...
    """
    construct causal graph from query
    confounders -> treatment, outcome
    treatment -> outcome
    mediators: treatment -> mediators -> outcome
    """
    ...
    # Instrumental variables: IV -> treatment
...
def calculate_ate(
    ...
    Args:
        ...
        mediators: mediators list
        instrumental_variables: instrument variable list
        estimator: estimator (if None, choose automatically)
        causal_graph: DAG (DOT, if None, construct automatically)
